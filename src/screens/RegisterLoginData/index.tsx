...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try {
      const oldPass = await AsyncStorage.getItem(dataKey);

      const oldPassData = JSON.parse(oldPass)

      if(oldPassData) {
        AsyncStorage.setItem(dataKey, JSON.stringify([...oldPassData, newLoginData]))
      }else {
